import logging, io, asyncio, nest_asyncio, json, os
...
# GOOGLE CREDS environment variable orqali yuklash
creds_json = os.getenv("GOOGLE_CREDS")
if not creds_json:
    raise Exception("❌ GOOGLE_CREDS environment variable topilmadi")
